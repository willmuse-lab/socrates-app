// ============================================================================
//  GoogleDriveBrowser — NOT CURRENTLY USED. An in-app Drive file list with
//  search, kept for a possible future upgrade. It needs the drive.readonly
//  scope (a Google "sensitive scope" requiring formal app verification) plus
//  the five /api/google/* backend functions, none of which exist. The live
//  Drive import uses GoogleDrivePicker.tsx (Google's own Picker, no review).
// ============================================================================
...
interface GoogleDriveBrowserProps { onFileSelected: (content: string) => void; }

export function GoogleDriveBrowser({ onFileSelected }: GoogleDriveBrowserProps) {
